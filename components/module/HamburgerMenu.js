...
function HamburgerMenu() {
  ...
  return (
    <div className="cursor-pointer relative">
      ...
      />
      <div
        className={`absolute text-white transition-all duration-500 ease-in-out left-0 right-[-33px] z-40 w-[107.3%] h-[100vh] rounded-lg shadow-lg transform overflow-hidden ${
      ...
      >
        ...
        {/* بخش فوتر زیبا */}
        <div className="absolute bottom-10 w-full flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <p className="text-xs mt-6 ">&copy; 2024 Psychologist</p>
        </div>
      </div>
    </div>
  );
